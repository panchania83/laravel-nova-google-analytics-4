...
Nova.booting(function (Vue, router, store) {
  Vue.component('GoogleAnalyticsCard', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    Nova.request().get("/api/ga4-most-visited-pages").then(function (response) {
...
var render = function() {
  ...
  return _c("card", { staticClass: "px-4 py-4" }, [
    _c("div", { staticClass: "mb-1" }, [
      _c("h5", { staticClass: "mr-3 text-base text-80 font-bold" }, [
    ...
    !_vm.pages
      ...
      : _c(
          ...
          _vm._l(_vm.pages, function(pagedata) {
            return _c("li", [
              _c(
                "a",
                {
                ...
                [_vm._v(_vm._s(pagedata.pagetitle))]
              ),
              _vm._v(": " + _vm._s(pagedata.totalusers) + "\n    ")
            ])
          }),
          0
        )
